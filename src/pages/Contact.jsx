...
const Contact = () => {
  ...
  return (
    <Layout>
      <div className="w-full pt-[140px] 2xl:h-[calc(100vh-100px)] pb-10 2xl:pb-0 bg-[url('/assets/contact.jpg')] bg-cover bg-center">
        <div className='flex justify-center'>
          <h1 className='w-fit text-2xl md:text-4xl px-4 py-3 font-medium text-white bg-slate-600 bg-opacity-50 rounded-lg'>{t("contact.title")}</h1>
        </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 w-full px-[10%] md:px-[15%]'>
            <div className='md:col-span-1 px-4 md:px-[38px] py-4 md:py-10 bg-slate-600 bg-opacity-50 flex flex-col justify-between rounded-xl md:rounded-r-none md:rounded-l-xl'>
              <div>
                ...
                <div>
                  <p className={`font-bold text-xl text-white mt-5 ${i18n.language === 'ar' ? 'text-right' : ''}`}>{t("contact.address")}</p>
                  <div className='border-2 border-white rounded-xl px-1 md:px-5 py-3 text-white flex items-center mt-3 gap-3'>
                    ...
                    <p>Çayır önü cad. Cemil Meriç Mah. No:9 Ümraniye/ İSTANBUL</p>
                  </div>
                </div>
                <div>
                  <p className={`font-bold text-xl text-white mt-5 ${i18n.language === 'ar' ? 'text-right' : ''}`}>{t("contact.title2")}</p>
                  <div className='flex flex-col gap-2 border-2 border-white rounded-xl pl-3 md:px-5 py-3 text-white mt-3'>
                    <div className='gap-3 flex items-center'>
                      ...
                      <p>+90 536 403 42 45</p>
                    </div>
                    <div className='gap-3 flex items-center'>
                      <SiGmail className='text-[1em]' />
                      <p className='text-xs md:text-base'>lavin_design_home@hotmail.com</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='flex gap-5 mt-10'>
                <a href="https://wa.me/+905364034245" target='_blank' rel="noreferrer">
                ...
                <a href="https://www.instagram.com/lavin_design_home/" target='_blank' rel="noreferrer">
                  <FaInstagram size={"2em"} className='text-white instagram transform hover:scale-110 transition-transform duration-300' />
                </a>
                <a href="mailto:lavin_design_home@hotmail.com?subject=&body=" target='_blank' rel="noreferrer">
